...
# example.com/nginy-operator-bundle:$VERSION and example.com/nginy-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/nginy-operator
...
IMG ?= rudderstack/nginy-operator:06
